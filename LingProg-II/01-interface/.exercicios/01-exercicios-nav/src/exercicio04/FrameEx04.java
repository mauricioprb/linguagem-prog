...
public class FrameEx04 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for(int i = 0; i < 5; i++){
            ...
            for(int j = 0; j<4; j++){
                texto = texto + (jTable_dados.getValueAt(i, j)) + "\n";
                try {
                    arq.gravarArq(texto, "tabela");
                } catch (IOException ex) {
                    Logger.getLogger(FrameEx04.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }                    
