...
public class FrameEx72 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setText("Mauricio Pereira");

        jTextField2.setEditable(false);
        jTextField2.setText("Ciência da Computação");

        jTextField3.setEditable(false);
        jTextField3.setText("4° Semestre");
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        FrameEx73 frameEx73 = new FrameEx73();
        frameEx73.setVisible(true);
        dispose();
